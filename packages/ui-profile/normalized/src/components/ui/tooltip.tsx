...
>(function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal id={useSpfxUiPortalId(props.id)} container={useSpfxUiPortalHost()}>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          {...props} id={props.id} render={useSpfxUiOwnedRender(props.render, props.id, "TooltipContent")}
        >
          {children}
