...
export function BaseUiIdOwnershipProvider(props) {
...
export function useBaseUiOwnedRootId(rootId) {
...
export function useBaseUiKeyedChildId(parentOwnedId, semanticPart) {
  const { deriveElementId } = useBaseUiIdOwnership();
...
export function useBaseUiRepeatedChildId(parentOwnedId, collectionKey, stableItemKey) {
  const { deriveElementId } = useBaseUiIdOwnership();
...
export function useBaseUiIdRef(parentOwnedId, targetSemanticPart) {
