...
export const DEFAULT_HEX_COLOR = '#8a8886';
...
export function normalizeHexColor(value: string): string {
  return parseHexColor(value) ?? DEFAULT_HEX_COLOR;
}
